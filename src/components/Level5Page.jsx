    ...
    <div style={{ paddingTop: '84px', background: 'var(--bg-primary)', minHeight: '100vh', position: 'relative' }}>
      ...
      <div style={{ maxWidth: 780, margin: '0 auto', padding: '32px 20px 64px', position: 'relative', zIndex: 1 }}>
        ...
        <SectionCard>
          ...
          <LevelImage src="/images/ftx_sbf.gif?v=2" alt="SBF FTX collapse" />
        ...
        <SectionCard>
          ...
          <LevelImage src="/images/luna_crash.gif?v=2" alt="Terra Luna death spiral chart" />
        ...
        <SectionCard>
          ...
          <LevelImage src="/images/bitconnect.gif?v=2" alt="BitConnect conference meme" />
        ...
        <SectionCard>
          ...
          <LevelImage src="/images/rug_pull.gif?v=2" alt="Rug pull meme" />
        </SectionCard>
        ...
        <SectionCard>
          ...
          <LevelImage src="/images/ngmi.gif?v=2" alt="NGMI" />
