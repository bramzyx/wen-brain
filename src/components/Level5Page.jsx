    ...
    <div style={{ paddingTop: '84px', background: 'var(--bg-primary)', minHeight: '100vh', position: 'relative' }}>
      ...
      <div style={{ maxWidth: 780, margin: '0 auto', padding: '32px 20px 64px', position: 'relative', zIndex: 1 }}>
        ...
        <SectionCard>
          ...
          <LevelImage src="/gifs/ftx_sbf.gif" alt="SBF FTX collapse" />
        ...
        <SectionCard>
          ...
          <LevelImage src="/gifs/luna_crash.gif" alt="Terra Luna death spiral chart" />
        ...
        <SectionCard>
          ...
          <LevelImage src="/gifs/bitconnect.gif" alt="BitConnect conference meme" />
        ...
        <SectionCard>
          ...
          <LevelImage src="/gifs/rug_pull.gif" alt="Rug pull meme" />
        </SectionCard>
        ...
        <SectionCard>
          ...
          <LevelImage src="/gifs/ngmi.gif" alt="NGMI" />
