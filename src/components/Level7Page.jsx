    ...
    <div style={{ paddingTop: '84px', background: 'var(--bg-primary)', minHeight: '100vh', position: 'relative' }}>
      ...
      <div style={{ maxWidth: 780, margin: '0 auto', padding: '32px 20px 64px', position: 'relative', zIndex: 1 }}>
        ...
        <SectionCard>
          ...
          <LevelImage src="/images/whale.gif?v=2" alt="Crypto whale market manipulation" />
        ...
        <SectionCard>
          ...
          <LevelImage src="/images/fake_volume.gif?v=2" alt="Fake volume wash trading" />
        ...
        <SectionCard>
          ...
          <LevelImage src="/images/pump_dump.gif?v=2" alt="Pump and dump scheme" />
        ...
        <SectionCard>
          ...
          <LevelImage src="/images/emotions.gif?v=2" alt="Crypto investor emotions cycle" />
        ...
        <SectionCard>
          ...
          <LevelImage src="/images/institutions.gif?v=2" alt="Institutional Bitcoin adoption" />
