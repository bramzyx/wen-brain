    ...
    <div style={{ paddingTop: '84px', background: 'var(--bg-primary)', minHeight: '100vh', position: 'relative' }}>
      ...
      <div style={{ maxWidth: 780, margin: '0 auto', padding: '32px 20px 64px', position: 'relative', zIndex: 1 }}>
        ...
        <SectionCard>
          ...
          <LevelImage src="/gifs/satoshi_ghost.gif" alt="Satoshi ghost mystery" />
        ...
        <SectionCard>
          ...
          <LevelImage src="/gifs/satoshi_theories.gif" alt="Satoshi theories conspiracy board" />
        ...
        <SectionCard>
          ...
          <LevelImage src="/gifs/satoshi_disappear.gif" alt="Satoshi disappears into the void" />
