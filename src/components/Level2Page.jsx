    ...
    <div style={{ paddingTop: '84px', background: 'var(--bg-primary)', minHeight: '100vh', position: 'relative' }}>
      ...
      <div style={{ maxWidth: 780, margin: '0 auto', padding: '32px 20px 64px', position: 'relative', zIndex: 1 }}>
        ...
        <SectionCard>
          ...
          <LevelImage src="/images/satoshi_ghost.gif?v=2" alt="Satoshi ghost mystery" />
        ...
        <SectionCard>
          ...
          <LevelImage src="/images/satoshi_theories.gif?v=2" alt="Satoshi theories conspiracy board" />
        ...
        <SectionCard>
          ...
          <LevelImage src="/images/satoshi_disappear.gif?v=2" alt="Satoshi disappears into the void" />
