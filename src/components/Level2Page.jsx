      ...
      <div style={{ maxWidth: 780, margin: '0 auto', padding: '32px 20px 64px', position: 'relative', zIndex: 1 }}>
        ...
        >
          ...
          <div className="flex gap-3 flex-wrap">
            {[['300 XP base', ACCENT], ['+150 perfect bonus', '#F7931A'], ['~6 min read', 'var(--text-secondary)']].map(([t, c]) => (
        ...
        >
          ...
          <div className="flex justify-center gap-8 mb-8">
            {[['+100 XP', 'per correct', ACCENT], ['+50 XP', 'speed bonus', '#F7931A'], ['+150 XP', 'perfect score', '#00FF94']].map(([val, lbl, c]) => (
