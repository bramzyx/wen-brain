...
const TERMS = [
  { word: 'DIAMOND HANDS', meaning: 'Holding through all volatility — no matter how bad it gets. Legendary or delusional. Sometimes both.', tweet: '"Down 80% and still holding. Diamond hands will prevail. 💎🙌"', color: '#00FF94' },
  { word: 'PAPER HANDS', meaning: 'Panic selling at the first sign of a dip. Then watching it moon without you.', tweet: '"Sold at the bottom. It went 10x next day. Classic paper hands energy."', color: '#FF3366' },
  { word: 'WEN MOON', meaning: "When will this coin's price go up significantly? The eternal question of every bag holder.", tweet: '"Wen moon ser? Soon. Always soon. The answer is always soon."', color: '#FFD700' },
  { word: 'CHAD', meaning: 'Someone who made a bold, confident, often correct move. Absolute legend energy.', tweet: '"Bought Bitcoin at $1 and held to $100k. Absolute chad. No notes."', color: '#9945FF' },
  { word: 'NORMIE', meaning: 'Someone outside crypto culture — unaware of the space. You were one once.', tweet: '"Tried explaining NFTs to my dad. He remains a normie. Respect the journey."', color: '#0099FF' },
]

const QUIZ = [
  { term: 'DIAMOND HANDS', q: 'Someone with "diamond hands" in crypto:', options: ['Sells at the first sign of a dip', 'Holds through all volatility, no matter what', 'Only buys stablecoins', 'Trades with leverage'], correct: 1, fact: '💎🙌 Diamond hands hold through 80% drawdowns. Legendary or delusional. Sometimes both.' },
  { term: 'PAPER HANDS', q: 'Having "paper hands" means you:', options: ['Only invest in NFTs', 'Panic sell during dips and market downturns', 'Trade using paper trading accounts', 'Hold stablecoins exclusively'], correct: 1, fact: 'Paper hands sell at the first red candle. Then watch the price moon without them. Classic.' },
  { term: 'WEN MOON', q: '"Wen moon" is crypto slang for:', options: ['A lunar calendar for trading signals', "When will this coin's price go up significantly?", 'A DeFi yield optimization strategy', 'Wrapped Ethereum Network Moon token'], correct: 1, fact: '"Wen moon ser" is the eternal question of every bag holder. The answer is always "soon."' },
  { term: 'CHAD', q: 'In crypto culture, calling someone a "chad" means:', options: ['They hold Chainlink tokens', 'They made a bold, confident, often correct move', 'They are a cryptocurrency developer', 'They run a centralized exchange'], correct: 1, fact: 'Buying Bitcoin at $1 and holding to $100k? Absolute chad move. History-making stuff.' },
  { term: 'NORMIE', q: 'A "normie" in crypto context is:', options: ['A normal-sized crypto transaction', 'Someone outside crypto culture, unaware of the space', 'A type of low-cap token', 'A Ethereum validator node'], correct: 1, fact: "You were a normie once. Now you're learning vocab on WenBrain. Congratulations on your evolution." },
]

function ConfettiBurst() {
  const colors = ['#9945FF', '#FFD700', '#00FF94', '#FF3366', '#0099FF', '#F7931A']
  return (
