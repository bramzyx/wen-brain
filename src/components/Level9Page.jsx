    ...
    <div style={{ paddingTop: '84px', background: 'var(--bg-primary)', minHeight: '100vh', position: 'relative' }}>
      ...
      <div style={{ maxWidth: 780, margin: '0 auto', padding: '32px 20px 64px', position: 'relative', zIndex: 1 }}>
        ...
        <SectionCard>
          ...
          <LevelImage src="/images/btc_etf.gif?v=2" alt="Bitcoin ETF approval" />
        ...
        <SectionCard>
          ...
          <LevelImage src="/images/halving.gif?v=2" alt="Bitcoin halving explained" />
        ...
        <SectionCard>
          ...
          <LevelImage src="/images/ai_crypto.gif?v=2" alt="AI and crypto combined" />
        ...
        <SectionCard>
          ...
          <LevelImage src="/images/layer2.gif?v=2" alt="Layer 2 blockchains explained" />
        ...
        <SectionCard>
          ...
          <LevelImage src="/images/cycle.gif?v=2" alt="Crypto market cycle" />
