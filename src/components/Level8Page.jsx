    ...
    <div style={{ paddingTop: '84px', background: 'var(--bg-primary)', minHeight: '100vh', position: 'relative' }}>
      ...
      <div style={{ maxWidth: 780, margin: '0 auto', padding: '32px 20px 64px', position: 'relative', zIndex: 1 }}>
        ...
        <SectionCard>
          ...
          <LevelImage src="/gifs/wallet_explained.gif" alt="Crypto wallet types explained" />
        ...
        <SectionCard>
          ...
          <LevelImage src="/gifs/seed_phrase.gif" alt="Seed phrase security" />
        ...
        <SectionCard>
          ...
          <LevelImage src="/gifs/cex_dex.gif" alt="CEX vs DEX explained" />
        ...
        <SectionCard>
          ...
          <LevelImage src="/gifs/charts.gif" alt="Crypto chart reading basics" />
        ...
        <SectionCard>
          ...
          <LevelImage src="/gifs/dyor.gif" alt="DYOR research guide" />
