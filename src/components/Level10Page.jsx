    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col gap-3 items-center">
          <a
            href={`https://twitter.com/intent/tweet?text=${tweet}&url=https://wenbrain.com?level=10`}
            target="_blank"
      ...
      <div style={{ maxWidth: 780, margin: '0 auto', padding: '32px 20px 64px', position: 'relative', zIndex: 1 }}>
        ...
        >
          ...
          <div className="flex gap-3 flex-wrap">
            {[['10 PTS base', ACCENT], ['+1 perfect bonus', '#FFA500'], ['~10 min read', 'var(--text-secondary)']].map(([t, c]) => (
        ...
        <SectionCard>
          ...
          <LevelImage src="/images/graduation.gif?v=2" alt="Graduation celebration" />
        ...
        <SectionCard>
          ...
          <LevelImage src="/images/mindset.gif?v=2" alt="Winning mindset" />
        ...
        <SectionCard>
          ...
          <LevelImage src="/images/dca.gif?v=2" alt="Dollar cost averaging strategy" />
        ...
        <SectionCard>
          ...
          <LevelImage src="/images/emotional_cycle.gif?v=2" alt="Crypto emotional cycle" />
        ...
        <SectionCard>
          ...
          <LevelImage src="/images/wagmi_final.gif?v=2" alt="WAGMI final celebration" />
