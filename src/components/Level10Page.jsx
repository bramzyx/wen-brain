    ...
    <div style={{ paddingTop: '84px', background: 'var(--bg-primary)', minHeight: '100vh', position: 'relative' }}>
      ...
      <div style={{ maxWidth: 780, margin: '0 auto', padding: '32px 20px 64px', position: 'relative', zIndex: 1 }}>
        ...
        <SectionCard>
          ...
          <LevelImage src="/gifs/graduation.gif" alt="Graduation celebration" />
        ...
        <SectionCard>
          ...
          <LevelImage src="/gifs/mindset.gif" alt="Winning mindset" />
        ...
        <SectionCard>
          ...
          <LevelImage src="/gifs/dca.gif" alt="Dollar cost averaging strategy" />
        ...
        <SectionCard>
          ...
          <LevelImage src="/gifs/emotional_cycle.gif" alt="Crypto emotional cycle" />
        ...
        <SectionCard>
          ...
          <LevelImage src="/gifs/wagmi_final.gif" alt="WAGMI final celebration" />
