  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-3 items-center">
        <a
          href={`https://twitter.com/intent/tweet?text=${tweet}&url=https://wenbrain.com/level/4`}
          target="_blank"
    ...
    <div style={{ paddingTop: '84px', background: 'var(--bg-primary)', minHeight: '100vh', position: 'relative' }}>
      ...
      <div style={{ maxWidth: 780, margin: '0 auto', padding: '32px 20px 64px', position: 'relative', zIndex: 1 }}>
        ...
        <SectionCard>
          ...
          <LevelImage src="/images/solana_start.gif?v=2" alt="Solana origin story" />
        ...
        <SectionCard>
          ...
          <LevelImage src="/images/ftx_crash.gif?v=2" alt="FTX collapse 2022" />
        </SectionCard>
        ...
        <SectionCard>
          ...
          <LevelImage src="/images/solana_meme.gif?v=2" alt="Solana memecoin chaos" />
