    ...
    <div style={{ paddingTop: '84px', background: 'var(--bg-primary)', minHeight: '100vh', position: 'relative' }}>
      ...
      <div style={{ maxWidth: 780, margin: '0 auto', padding: '32px 20px 64px', position: 'relative', zIndex: 1 }}>
        ...
        <SectionCard>
          ...
          <LevelImage src="/gifs/solana_start" alt="Solana origin story" />
        ...
        <SectionCard>
          ...
          <LevelImage src="/gifs/ftx_crash" alt="FTX collapse 2022" />
        </SectionCard>
        ...
        <SectionCard>
          ...
          <LevelImage src="/gifs/solana_meme" alt="Solana memecoin chaos" />
