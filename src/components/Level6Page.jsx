    ...
    <div style={{ paddingTop: '84px', background: 'var(--bg-primary)', minHeight: '100vh', position: 'relative' }}>
      ...
      <div style={{ maxWidth: 780, margin: '0 auto', padding: '32px 20px 64px', position: 'relative', zIndex: 1 }}>
        ...
        <SectionCard>
          ...
          <LevelImage src="/gifs/doge_moon" alt="Doge to the moon" />
        ...
        <SectionCard>
          ...
          <LevelImage src="/gifs/memecoin_family" alt="Memecoin family tree" />
        </SectionCard>
        ...
        <SectionCard>
          ...
          <LevelImage src="/gifs/pumpfun" alt="Pump.fun memecoin chaos" />
        ...
        <SectionCard>
          ...
          <LevelImage src="/gifs/wagmi_ngmi" alt="WAGMI vs NGMI" />
        ...
        <SectionCard>
          ...
          <LevelImage src="/gifs/degen_life" alt="Degen life" />
