  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-3 items-center">
        <a
          href={`https://twitter.com/intent/tweet?text=${tweet}&url=https://wenbrain.com/level/3`}
          target="_blank"
    ...
    <div style={{ paddingTop: '84px', background: 'var(--bg-primary)', minHeight: '100vh', position: 'relative' }}>
      ...
      <div style={{ maxWidth: 780, margin: '0 auto', padding: '32px 20px 64px', position: 'relative', zIndex: 1 }}>
        ...
        <SectionCard>
          ...
          <LevelImage src="/images/vitalik_young.gif?v=2" alt="Vitalik Buterin young genius" />
        ...
        <SectionCard>
          ...
          <LevelImage src="/images/dao_hack.gif?v=2" alt="The DAO hack 2016" />
        ...
        <SectionCard>
          ...
          <LevelImage src="/images/eth_ecosystem.gif?v=2" alt="Ethereum ecosystem growing" />
