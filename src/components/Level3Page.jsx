    ...
    <div style={{ paddingTop: '84px', background: 'var(--bg-primary)', minHeight: '100vh', position: 'relative' }}>
      ...
      <div style={{ maxWidth: 780, margin: '0 auto', padding: '32px 20px 64px', position: 'relative', zIndex: 1 }}>
        ...
        <SectionCard>
          ...
          <LevelImage src="/gifs/vitalik_young.gif" alt="Vitalik Buterin young genius" />
        ...
        <SectionCard>
          ...
          <LevelImage src="/gifs/dao_hack.gif" alt="The DAO hack 2016" />
        ...
        <SectionCard>
          ...
          <LevelImage src="/gifs/eth_ecosystem.gif" alt="Ethereum ecosystem growing" />
